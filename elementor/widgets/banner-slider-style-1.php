...
<div class="gen-banner-movies banner-style-2">
	<div class="owl-carousel" <?php echo $this->get_render_attribute_string('slider'); ?>>
		...
		?>
				<div class="item item-banner-id-<?php echo the_ID(); ?>" style="background: url('<?php echo $image_url; ?>')">
					<div class="gen-movie-contain-style-2 h-100">
						<div class="container h-100">
							<div class="row flex-row-reverse align-items-center h-100">
								<div class="col-xl-<?php echo $layout[1]; ?>">
									<?php
									$class = '';
								...
								<div class="col-xl-<?php echo $layout[0]; ?>">
										...
										<h3>
											<a href="<?php the_permalink(); ?>">
												...
												if (!function_exists('get_field')) {
													...
													$size = 'full';
													$titleImage = get_field('image_logo');
													if (!$titleImage) {
														echo get_the_title();
													} else {
